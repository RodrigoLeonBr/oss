...
class IndicadorController {
    ...
    criar = async (req, res, next) => {
        try {
            ...
            return res.status(httpStatus.CREATED).json({ status: true, message: 'Indicador criado', data: indicador });
        } catch (e) {
            logger.error(e);
            return next(e);
        }
    ...
    atualizar = async (req, res, next) => {
        try {
            ...
            return res.status(httpStatus.OK).json({ status: true, message: 'Indicador atualizado', data: indicador });
        } catch (e) {
            logger.error(e);
            return next(e);
        }
